...
public class List implements Parcelable
{
    ...
    @Expose
    private java.util.List<Weather1> weather = null;
    ...
    protected List(Parcel in) {
        ...
        in.readList(this.weather, (Weather1.class.getClassLoader()));
     ...
     * @param main
     */
    public List(Integer dt, Main main, java.util.List<Weather1> weather, Clouds clouds, Wind wind, Rain rain, Sys sys, String dtTxt) {
        super();
        this.dt = dt;
        this.main = main;
    ...
    public java.util.List<Weather1> getWeather() {
        return weather;
    }

    public void setWeather(java.util.List<Weather1> weather) {
        this.weather = weather;
    }
